      ...
      content: (
        <div className="flex flex-col items-center">
          <div className="text-[13px] sm:text-[13px] md:text-[13px] lg:text-[15px] w-[55vw] text-left">
            Predation is another significant source of mortality, particularly at breeding colonies. While Leach’s storm-petrel colonies were historically free of mammalian predators, introduced foxes and expanding gull populations have increasingly targeted nesting sites (<a href="https://doi.org/10.5751/ACE-02388-180105">Bond et al., 2023</a>; <a href="https://doi.org/10.5751/ACE-02370-180111">Pollet, Lenske, et al., 2023</a>). ). Gull predation on adult petrels is of particular concern, and we extrapolated estimates from predation transect studies at Gull Island (<a href="https://doi.org/10.5751/ACE-02388-180105">Bond et al. 2023</a>) to estimate predation mortality rates at each colony. Estimates of predation by foxes at off-colony sites was informed by recent data on reported mortality from <a href="https://doi.org/10.1656/045.032.0105">Wilhelm et al. (2025)</a>.
            
             In our model, predation mortality was incorporated by estimating reported kills and linking them to stage-specific mortality rates. Specifically, observed predation rates were divided by the estimated population size at each time period, and for post-fledging mortality, we used the product of productivity at time t (<strong>F<sub>t</sub></strong>) and breeder population size (<strong>N<sub>3tc</sub></strong>) to estimate the total number of fledglings at risk. By incorporating both reported and estimated predation impacts, our model captures the variability in predation pressure across different colonies and years. These findings emphasize the importance of ongoing monitoring and mitigation strategies, particularly at colonies with high predation pressure, to support the conservation of Leach’s storm-petrel populations.
          </div>
      ...
      <div className="bg-white shadow-lg rounded-lg border border-gray-300 p-[1vw] mx-[1vw]">
        ...
        <div className="bg-gray-100 rounded-lg p-4 m-[1vw]">
          <div className="flex flex-col justify-center items-start sm:flex-row">
            <span className="text-[13px] sm:text-[13px] md:text-[13px] lg:text-[15px] w-[55vw] max-w-[950px]">
            Observed mortality in Leach’s storm-petrels is a critical factor in understanding population declines, particularly given the species’ life-history strategy, which relies on high adult survival for stability (<a href="https://doi.org/10.1201/9781420036305">Hamer et al., 2001</a>; <a href="https://doi.org/10.1201/9781420036305">Schreiber & Burger, 2001</a>). Two key drivers of mortality identified in the region are <strong>predation at breeding colonies</strong> and <strong>disturbance/disorientation caused by artificial light sources</strong>. Avian and mammalian predation, particularly by gulls and foxes, has been recognized as a primary onshore threat, with colony-specific impacts  (<a href="https://ace-eco.org/vol18/iss1/art5/">Bond et al., 2023</a>; <a href="https://ace-eco.org/vol18/iss1/art11/">Pollet, Lenske, et al., 2023</a>). Meanwhile, light pollution from offshore installations and coastal infrastructure contributes to strandings, further exacerbating mortality risks (<a href="https://epe.lac-bac.gc.ca/100/201/300/avian_conservation_ecology-ef/v01n01-v16n02/www.ace-eco.org/vol16/iss1/art22/default.htm">Gjerdrum et al., 2021</a>). Predation by foxes at sites away from colonies has also recently been observed (<a href="https://doi.org/10.1656/045.032.0105">Wilhelm et al. 2025</a>). Read more about the types of data incorporated into our observed deaths model below. <br></br><br></br>

            <strong>The model incorporates two key parameters related to mortality: D<sub>source, stc</sub> and H<sub>source, stc</sub></strong>.<br></br> 
            
            D<sub>source, stc</sub> represents the reported number of individuals killed by specific observable mortality sources for each stage (s), time (t), and colony (c). H<sub>source, stc</sub> is the corresponding mortality rate, calculated by dividing D<sub>source, stc</sub> by the population size at stage s and time t in colony c (<strong>N<sub>stc</sub></strong>). For post-fledging mortality, where direct population estimates in the first stage class at time t (<strong>N<sub>0t</sub></strong>) are unavailable, the model uses the product of productivity at time t (<strong>F<sub>t</sub></strong>) and half of the breeding population size (<strong>N<sub>3,t / 2</sub></strong>) to estimate the total number of fledglings. This approach links observed mortality to the overall population dynamics across different life stages.
        ...
        {sections.map(({ id, title, content }) => (
          ...
          >
            <div className="flex justify-between items-center bg-[#EC7D33] rounded-lg cursor-pointer px-[1vw]">
