...
const IPMGraphic: React.FC = () => {
  ...
  const imageGroups = [
    {
      src: "/images/LESP/mortality.svg",
      left: "50%",
      top: "10%",
      info: "OBSERVED DEATHS",
      component: <MortalityModel />,
    },
    {
      src: "/images/LESP/survival.svg",
      left: "40%",
      top: "47%",
      info: "OBSERVED DEATHS",
      component: <MortalityModel />,
    ...
    {
      src: "/images/LESP/population.svg",
      left: "6.5%",
      top: "67%",
    ...
    {
      src: "/images/LESP/reproductive.svg",
      left: "28%",
      top: "5%",
      info: "PRODUCTIVITY",
