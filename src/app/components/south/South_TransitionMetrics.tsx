...
interface South_TransitionMetricsProps {
      ...
      {selectedSite === "Southern Nova Scotia" ? ( // Check if the selected site is "Southern Nova Scotia"
        <>
          ...
          <div className="mt-4">
            ...
            >
              <iframe
                src="/figures/South/Psi0.html" // Psi0 plot source file
          ...
          <div className="mt-4">
            ...
            >
              <iframe
                src="/figures/South/Psi1.html" // Psi1 plot source file
...
export default South_TransitionMetrics;
